...
import com.metacto.core.utils.extensions.formatToMaxTwoDecimals
import com.metacto.core.utils.extensions.removeAllNonDecimal

@Composable
fun DecimalPriceInputField(
    ...
    BaseTextInputField(
        ...
        textStyle = textStyle,
        visualTransformation = DecimalCurrencyAmountInputVisualTransformation(style = visualTransformationSpanStyle),
        maxLines = 1,
        singleLine = true,
        ...
        onValueChange = { value ->
            if (value.isEmpty()) {
                ...
                val updatedValue = value.removeAllNonDecimal().formatToMaxTwoDecimals()
                onPriceChange?.invoke(updatedValue)
            }
        }
    )
}