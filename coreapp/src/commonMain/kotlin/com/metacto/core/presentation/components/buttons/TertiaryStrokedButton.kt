...
fun TertiaryStrokedButton(
    ...
    disabledBgColor: Color = CoreTheme.colors.tertiaryStrokedButton.disabledBgColor,
    elevation: Dp = CoreTheme.spacings.tertiaryStrokedButton.elevation,
    contentSpacing: Dp = CoreTheme.spacings.tertiaryStrokedButton.contentSpacing,
