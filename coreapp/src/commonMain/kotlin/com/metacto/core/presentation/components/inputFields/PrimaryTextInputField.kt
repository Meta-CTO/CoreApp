...
fun PrimaryTextInputField(
    ...
    iconTintColor: Color = CoreTheme.colors.primaryInputFieldIconColor,
    ...
    backgroundColor: Color = CoreTheme.colors.primaryInputFieldBg,
    focusedBorderColor: Color = CoreTheme.colors.primaryInputFieldFocusedBorderColor,
    unFocusedBorderColor: Color = CoreTheme.colors.primaryInputFieldUnFocusedBorderColor,
    textColor: Color = CoreTheme.colors.primaryInputFieldTextColor,
    placeholderTextStyle: TextStyle = CoreTheme.typography.primaryInputFieldPlaceholderTextStyle,
    placeholderTextColor: Color = CoreTheme.colors.primaryInputFieldPlaceholderColor,
    labelTextStyle: TextStyle = CoreTheme.typography.primaryInputFieldLabelTextStyle,
    labelTextColor: Color = CoreTheme.colors.primaryInputFieldLabelColor,
    errorTextStyle: TextStyle = CoreTheme.typography.primaryInputFieldErrorTextStyle,
    errorTextColor: Color = CoreTheme.colors.primaryInputFieldErrorColor,
) {
    BaseTextInputField(
