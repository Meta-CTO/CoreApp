...
fun TertiaryTextButton(
    ...
    iconSize: Dp = CoreTheme.spacings.tertiaryTextButton.iconSize,
    iconColor: Color? = CoreTheme.colors.tertiaryTextButton.iconColor,
    spacing: Dp = CoreTheme.spacings.tertiaryTextButton.spacing,
    padding: PaddingValues = PaddingValues(vertical = CoreTheme.spacings.tertiaryTextButton.paddingVertical),
