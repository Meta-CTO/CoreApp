...
fun PrimaryTextButton(
    ...
    iconSize: Dp = CoreTheme.spacings.primaryTextButton.iconSize,
    iconColor: Color? = CoreTheme.colors.primaryTextButton.iconColor,
    spacing: Dp = CoreTheme.spacings.primaryTextButton.spacing,
    padding: PaddingValues = PaddingValues(vertical = CoreTheme.spacings.primaryTextButton.paddingVertical),
