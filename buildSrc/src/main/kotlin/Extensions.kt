...
fun DependencyHandler.ksp(kspNotation: String): Dependency? =
    add("ksp", kspNotation)

fun getGitCommitCount(): Int {
    return Integer.valueOf(System.getenv("GITHUB_RUN_NUMBER") ?: "1")
}

fun getVersionName(): String {
    val version = Integer.valueOf(System.getenv("GITHUB_RUN_NUMBER") ?: "1")
    return "1.0.$version"
}
